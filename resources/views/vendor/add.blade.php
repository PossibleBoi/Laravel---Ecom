                                ...
                                <table class="table table-dark table-hover" border="1">
                                    ...
                                    <tr>
                                        <form action="{{route('team.create')}}" method='post'>
                                            @csrf
                                            @method('post')
                                            <td><input type="text" name="display_name" placeholder="Enter Team Name">
                                            </td>
                                            <td><textarea name="description" placeholder="Enter Team Description"></textarea>
                                            </td>
                                            <td><button type="submit"class="ml-4">Add Team</button></td>
                                        </form>
                                    </tr>
                                </table>
                            </div>
                            <a href="{{ route('admin.vendors') }}">Cancel</a>
                        </div><!-- /.container-fluid -->
                    </div>
                    <!-- /.content-header -->
