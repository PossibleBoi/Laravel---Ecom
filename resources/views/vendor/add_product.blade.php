                                ...
                                <div class="col-md-12">
                                    <form action="{{ route('product.create') }}" method="post"
                                        ...
                                        <ul class="list-group">
                                            ...
                                            @if ($errors->has('price'))
                                                <span
                                                    class="text-danger">{{ 'Price is required and should be a number.' }}</span>
                                            @endif
                                            <li
                                                class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            @if ($errors->has('stock'))
                                                <span
                                                    class="text-danger">{{ 'Stock is required and should be a number.' }}</span>
                                            @endif
                                            <li
                                                class="list-group-item d-flex justify-content-between align-items-center">
                                                <input type="text" name='brand' class="form-control"
                                                    value="{{ old('brand') }}" placeholder="Brand">
                                            </li>
                                            @if ($errors->has('brand'))
