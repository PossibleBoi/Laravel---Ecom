                                 ...
                                 <table class="table table-dark table-hover" border=1>
                                     ...
                                     @foreach ($products as $product)
                                         <tr>
                                             ...
                                             <td>{{ $product->price }} </td>
                                             <td>{{ $product->stock }}</td>
                                             <td><img src="{{ asset($product->image) }}" width="125px" height="125px">
                                             </td>

                                             <td>
                                                 <a
                                                     href="{{ route('product.edit', ['product' => $product->imageable_id]) }}">Edit</a>
                                                 <br><br>

                                                 <form method='POST'
                                                     action="{{ route('product.delete', ['product' => $product->imageable_id]) }}">
                                                     @csrf
                                                     @method('DELETE')
